...
export function Settings() {
  ...
  const handleCopyEnvInfo = async () => {
    const info = `
App Name: RELU LEAD ENRICHER
Version: 1.0.0
Environment: ${import.meta.env.VITE_API_URL ? 'Production' : 'Development'}
Backend API Base URL: ${API_URL}
AI Model Target: gemini-flash-latest
MongoDB Target: Remote MongoDB
Current API Latency: ${health.latency}
Internet State: ${health.internet}
API Status: ${health.api}
MongoDB Status: ${health.mongodb}
Gemini Status: ${health.gemini}
    `.trim();
  ...
  const handleDownloadLogs = () => {
    const logs = `
RELU LEAD ENRICHER - SYSTEM DIAGNOSTICS
========================================
...
Gemini Status:
${health.gemini.toUpperCase()}

Internet Status:
${health.internet.toUpperCase()}

Ping Latency:
${health.latency}

Total API Diagnostics:
    ...
    <div className="settings-page-layout">
      ...
      <section className="settings-card-panel">
        ...
        <p className="panel-desc">
          Real-time status indicators checking microservices and
        ...
        <div className="health-grid-3">
          ...
          <div className="health-status-card">
            ...
            <div className="status-indicator-row">
              <span className={`status-led ${health.api}`} />
          ...
          <div className="health-status-card">
            ...
            <div className="status-indicator-row">
              <span className={`status-led ${health.mongodb}`} />
          ...
          <div className="health-status-card">
            ...
            <div className="status-indicator-row">
              <span className={`status-led ${health.gemini}`} />

              <span className="status-txt">
                {health.gemini === 'online'
                  ? 'Active'
                  : 'Configuration Error'}
              </span>
            </div>
          ...
          <div className="health-status-card">
            ...
            <div className="status-indicator-row">
              <span
                className={`status-led ${health.internet}`}
              />
      ...
      <div className="settings-split-grid">
        ...
        <section className="settings-card-panel flex-2">
          ...
          <p className="panel-desc">
            Configure dashboard UI views and local operation
            choices.
          </p>
            ...
            <div className="toggle-grid mt-4">
              ...
              <label className="toggle-row-item">
                ...
                <div className="toggle-text">
                  ...
                  <span className="toggle-desc">
                    Show transition slides and loader steps
                  </span>
                </div>
              </label>
              ...
              <label className="toggle-row-item mt-3">
                ...
                <div className="toggle-text">
                  ...
                  <span className="toggle-desc">
                    Retrieve historical leads list periodically
                  </span>
                </div>
              </label>
              ...
              <label className="toggle-row-item mt-3">
                ...
                <div className="toggle-text">
                  ...
                  <span className="toggle-desc">
                    Display popup banners on successful
                    enrichment
                  </span>
                </div>
              </label>
              ...
              <label className="toggle-row-item mt-3">
                ...
                <div className="toggle-text">
                  ...
                  <span className="toggle-desc">
                    Show warning dialog before deleting records
                  </span>
                </div>
              </label>
          ...
          <section className="settings-card-panel">
            ...
            <div className="dev-tools-buttons-row">
              ...
              <button
                ...
                className="btn-action-neutral mt-2"
              >
                <Download size={14} />
